# NEUS: Non-Equilibrium Usadel Solver

NEUS is a set of numerical programs for solving the Usadel diffusion equation in one-dimensional superconducting nanostructures, both in and out of equilibrium.
...
The software itself is released under the [MIT open-source licence](https://github.com/jabirali/NEUS/blob/master/LICENSE.md);
...
[documentation](https://jabirali.github.io/NEUS/html/page/index.html).
