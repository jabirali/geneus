...
### GNEUS: General Non-Equilibrium Usadel Solver
...
The source is available on [Github](https://github.com/jabirali/GNEUS).
...
For instructions on how to install GNEUS, continue to the [next part](01-installation.html) of the manual.
