...
program test_core
  ...
  call subsection('Testing output:')
  s0 = propagator(pauli0, pauli1, pauli2, pauli3)
  call s0%print

  call subsection('Testing assignment operator:')
  rw = [ (n, n=1,32) ]
  s0 = rw
  s1 = propagator( spin([( 1.000000000000000_wp, 2.000000000000000_wp), ( 3.000000000000000_wp, 4.000000000000000_wp),   &
  ...
  s0 = propagator( (0.0_wp,0.001_wp), (1.0_wp,0.0_wp) )
  s1 = propagator( spin([( 0.000000000000000_wp, 0.000000000000000_wp), ( 0.000000000000000_wp,-0.999000499999875_wp),   &
  ...
  s0 = propagator( (1.0_wp,0.001_wp), (1.0_wp,0.0_wp) )
  s1 = propagator( spin([( 0.000000000000000_wp, 0.000000000000000_wp), ( 0.968385128104009_wp,-0.030630683283800_wp),   &
  ...
  s0 = propagator( (1.0_wp,0.001_wp), (0.0_wp,1.0_wp) )
  s1 = propagator( spin([( 0.000000000000000_wp, 0.000000000000000_wp), ( 0.030630683283800_wp, 0.968385128104009_wp),   &
  ...
  s0 = propagator( (2.0_wp,0.001_wp), (1.0_wp,0.0_wp) )
  s1 = propagator( spin([( 0.000000000000000_wp, 0.000000000000000_wp), ( 0.267949096206123_wp,-0.000154700474229_wp),   &
