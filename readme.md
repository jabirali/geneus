...
@NOTE
  If you are reading this document in a plaintext format, please note that this README-file
  along with a full API-reference should also be available in HTML-form in the subdirectory
  `doc` of the project root. The HTML documentation includes autogenerated documentation of
  all programs, modules, interfaces, subroutines, and functions provided by the project.
