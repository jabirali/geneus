...
module spin_m
    ...
    contains
        ...
        generic :: operator(+) => addl_rscalar, addr_rscalar, addl_cscalar, addr_cscalar, &
            addl_cmatrix, addr_cmatrix, add_spin
        generic :: operator(-) => subl_rscalar, subr_rscalar, subl_cscalar, subr_cscalar, &
            subl_cmatrix, subr_cmatrix, sub_spin
        generic :: operator(*) => mull_rscalar, mulr_rscalar, mull_cscalar, mulr_cscalar, &
            mull_cmatrix, mulr_cmatrix, mul_spin
