...
contains
    ...
    !! to make the calculations more stable near strong ferromagnetic materials.
        ...
        ! Status information
        if (this%information .ge. 0 .and. this%order .gt. 0) then
    ...
    !!   and often converged more slowly. These methods have therefore been discarded.
        ...
        if (associated(this%material_a)) then
            u = u .or. (this%material_a%order .gt. 0)
        end if
        if (associated(this%material_b)) then
            u = u .or. (this%material_b%order .gt. 0)
        end if
        if (u) then
